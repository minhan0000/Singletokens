...
const TEXT_MODELS = [
  ...
  {name:'GPT-5',provider:'OpenAI',mult:2,tag:'Neuestes',tagClass:'tag-red',cls:'expensive'},
  {name:'OpenAI o1',provider:'OpenAI',mult:5,tag:'Reasoning',tagClass:'tag-red',cls:'expensive'},
  {name:'OpenAI o1 Mini',provider:'OpenAI',mult:0.5,tag:'Reasoning',tagClass:'tag-muted',cls:''},
  {name:'Gemini 2.5 Pro',provider:'Google',mult:0.5,tag:'Thinking',tagClass:'tag-blue',cls:'',isNew:true},
  {name:'Gemini Pro 2.0',provider:'Google',mult:0.3,tag:'Multimodal',tagClass:'tag-blue',cls:''},
  {name:'Gemini Flash 2.0',provider:'Google',mult:0.08,tag:'Günstig',tagClass:'tag-cyan',cls:'cheap'},
  ...
  {name:'Mistral Large 2',provider:'Mistral',mult:0.7,tag:'Europäisch',tagClass:'tag-muted',cls:''},
  {name:'Mistral Small',provider:'Mistral',mult:0.12,tag:'Effizient',tagClass:'tag-green',cls:'cheap'},
  {name:'DeepSeek V3',provider:'DeepSeek',mult:0.15,tag:'Open Source',tagClass:'tag-green',cls:'cheap'},
  {name:'Qwen 2.5 72B',provider:'Alibaba',mult:0.15,tag:'Open Source',tagClass:'tag-cyan',cls:'cheap'},
  {name:'Grok 2',provider:'xAI',mult:0.5,tag:'Von xAI',tagClass:'tag-muted',cls:''},
  {name:'Perplexity Sonar Pro',provider:'Perplexity',mult:1.5,tag:'Web-Suche',tagClass:'tag-green',cls:'',isNew:true},
  {name:'Command R+',provider:'Cohere',mult:0.3,tag:'RAG',tagClass:'tag-green',cls:'cheap',isNew:true},
  {name:'Phi-4 Mini',provider:'Microsoft',mult:0.05,tag:'Kompakt',tagClass:'tag-cyan',cls:'cheap',isNew:true},
  {name:'Amazon Nova Lite',provider:'Amazon',mult:0.05,tag:'Günstig',tagClass:'tag-cyan',cls:'cheap',isNew:true},
  {name:'Gemma 2 27B',provider:'Google',mult:0.1,tag:'Open Source',tagClass:'tag-cyan',cls:'cheap'},
];
